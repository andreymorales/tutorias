...
function showHeadquarterList()
 {
	...
	$vJSON.=', {"text":"Facultad de Contaduría y Administración, Campus I", "value":"1"}';
...
$mxajax->register(XAJAX_FUNCTION, "showHeadquarterList");
$mxajax->register(XAJAX_FUNCTION, "showLevelList");
